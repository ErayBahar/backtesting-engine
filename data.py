...
class DataHandler(object):
    ...
    The goal of a DataHandler object is to output a generated set of
    ...
    def update_bars(self):
        """
        Pushes the latest bar to the latest_symbol structure
...
class HistoricCSVDataHandler(DataHandler):
        ...
        def get_new_bar(self, symbol):
            """
            Returns the latest bar from the latest_symbol_data
            list for the requested symbol.
            """
